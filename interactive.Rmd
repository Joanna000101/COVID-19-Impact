...
<!-- Add buttons -->
<button onclick="update(data1)">2018 GDP</button>
<button onclick="update(data2)">2019 GDP</button>
<button onclick="update(data3)">2020 GDP</button>
<button onclick="update(data4)">2021 GDP</button>
